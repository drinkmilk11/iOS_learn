...
class DuduController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
...
//        cell.label.text = data[indexPath.item] // 配置 cell 的标签
        cell.numberLabel.text = "data"
        return cell
    }
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        if indexPath.item < 5 {
            insertNewItemAtFifthPosition(indexpath: indexPath)
//            UIView.animate(withDuration: 0.6) {
//                
//            } completion: { dd in
//                self.insertNewItemAtFifthPosition(indexpath: indexPath)
//            }
        } else {
